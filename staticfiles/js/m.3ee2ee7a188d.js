    ...
    if (document.getElementsByName("ebatsman1")[0].innerHTML.length < 70) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                document.getElementsByName("ebatsman2")[0].innerHTML += t3;
...
function live() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#livecomm").prepend("<li class='collection-item avatar'><i style='margin-top:10px;' class='circle' run=" + data.livecomment.run + ">" + data.livecomment.over + "." + data.livecomment.ball + "</i><span style='margin-top:13px;margin-bottom:5px;' class='title'><span style='background-color:lightblue;border-radius:80%;padding:7px 10px;'>" + data.livecomment.run + "</span> <b>" + data.livecomment.bowler + "</b> to <b>" + data.livecomment.batsman + "</b>" + other + "</span><p style='margin-left:4px'>" + data.livecomment.remark + "</p></li>");
            circleColor();
        }
    });
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    webSocketBridge.listen(function(action, stream) {
            ...
            if (action.event == "New Commentary" && $("#match").val() == action.id && $("#status").val() == "Live") {
                ...
                var card = $("<li class='collection-item avatar'><i style='margin-top:10px;' class='circle' run='" + action.runs + "'>" + action.overs + "." + action.balls + "</i><span style='margin-top:13px;margin-bottom:5px;' class='title'><span style='background-color:lightblue;border-radius:80%;padding:7px 10px;'>" + action.runs + "</span> <b>" + action.bowler + "</b> to <b>" + action.batsman + "</b>" + other + "</span><p style='margin-left:4px'>" + action.remarks + "</p></li>");
